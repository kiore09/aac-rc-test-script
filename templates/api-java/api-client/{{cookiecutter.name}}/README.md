...
This is a sample Java application that calls an API endpoint on an email proxy service [Outbound Email through API Client Service](docs/OutboundEmailProxy.png), demonstrating the following feature implementations:  
