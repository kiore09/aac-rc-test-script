# {{ cookiecutter.name }}
This is a sample GraphQL application (backed by CloudSQL) to demonstrate the following feature implementation:
...
> [!IMPORTANT] 
> Cloud SQL is not accessible from Codespaces development environment. In order to test your code connecting to Cloud SQL, you need to follow the instructions for local development, or deploy your code to GKE. </span>   
