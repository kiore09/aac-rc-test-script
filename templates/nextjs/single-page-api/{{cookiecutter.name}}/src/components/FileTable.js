...
Description: File table component with static sampleData render, download implementation and pagination
===========================================================================
*/
'use client'
      ...
      <FlexGrid.Row horizontalAlign="center">
        <Box bottom={4}>
          <Typography variant={{ size: 'h4' }}>
            {`Files Uploaded: ${tableData.length}`}
          </Typography>
        </Box>
      </FlexGrid.Row>
      <FlexGrid.Row horizontalAlign="center">
