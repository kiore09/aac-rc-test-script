...
/**
 * FileUpload handles file selection, validation, and upload.
 * @param {Object} tableData - The data for the table.
 * @param {Number} dataCount - The count of the data.
 * @param {Function} onFileUpload - Callback function for file upload.
 */

function FileUpload({ tableData, dataCount, onFileUpload }) {
  ...
  const handleSubmit = async () => {
    if (fileName && fileContent) {
      ...
      try {
        await onFileUpload(updatedTableData);
