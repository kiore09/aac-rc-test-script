...
collection through the cqrs query model controller on GCP.
===========================================================================
*/
package com.telus.samples.cqrsquery;
...
public class cqrsQueryController{
    private static final Logger logger = LoggerFactory.getLogger(cqrsQueryController.class);
     ...
     * collection whenever a client hits GET /cqrsquery (e.g. localhost:8080/cqrsquery)
     * 
     ...
     */
    @GetMapping("/cqrsquery")
    public String cqrsqueryDisplay(Model model) {
        try {
            ...
            // Initialize firestore service for retreiving collection
