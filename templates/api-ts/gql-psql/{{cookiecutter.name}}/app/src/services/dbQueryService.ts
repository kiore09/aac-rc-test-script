 ...
 * @returns
 */
const getCustomerFromDB = async (id: number): Promise<any> => {
  // get data from database
  try {
    // Query the 'item' table from the database.
    logger.info("Getting data from database...");
 ...
 * @returns
 */
const getItemFromDB = async (id: number): Promise<any> => {
  // get data from database
  try {
    // Query the 'item' table from the database.
    logger.info("Getting data from database...");
 ...
 * @returns
 */
const getOrderFromDB = async (id: number): Promise<any> => {
  // get data from database
  try {
    // Query the 'item' table from the database.
    logger.info("Getting data from database...");
    return await pool?.select("*").from("order").where("Id", id).first();
  } catch (err) {
    logger.error(`An error has occurred: ${err}`);
    throw new Error(err.message);
  }
